...
public class TestIcebergInputFormatHelper {
    ...
    public TestIcebergInputFormatHelper(HadoopTables tables, Schema schema, PartitionSpec spec, FileFormat fileFormat, TemporaryFolder tmp, File location) {
        this.tables = tables;
        this.schema = schema;
        this.spec = spec;
    ...
    public Table createTable(Schema schema, PartitionSpec spec) {
        ...
        table = tables.create(schema, spec, properties, location.toString());
        return table;
    }
